      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">StyleMart</span>
            </div>
            <p className="text-gray-400 mb-4">
              Nigeria's premier multi-vendor marketplace connecting buyers with verified vendors across the country.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white">
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.621 5.367 11.988 11.988 11.988s11.987-5.367 11.987-11.988C24.004 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.321-1.291C3.897 14.476 3.6 12.955 3.6 11.39c0-1.565.297-3.085 1.528-4.306.872-.801 2.023-1.291 3.321-1.291s2.448.49 3.321 1.291c1.231 1.221 1.528 2.741 1.528 4.306 0 1.565-.297 3.086-1.528 4.307-.873.801-2.024 1.291-3.321 1.291z"/>
                </svg>
              </a>
              <a href="#" className="text-gray-400 hover:text-white">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/deals" className="text-gray-400 hover:text-white">Special Deals</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/auth/register?role=vendor" className="text-gray-400 hover:text-white">Become a Vendor</Link></li>
              <li><Link href="/vendor-guide" className="text-gray-400 hover:text-white">Vendor Guide</Link></li>
              <li><Link href="/vendor/login" className="text-gray-400 hover:text-white">Vendor Login</Link></li>
              <li><Link href="/advertising" className="text-gray-400 hover:text-white">Advertise with Us</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 StyleMart. All rights reserved.
          </p>
